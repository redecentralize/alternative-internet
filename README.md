...
* [private.sh](https://private.sh/) The search engine that cryptographically protects your privacy it uses [gigablast](https://www.gigablast.com/) as data source. It is the only web search engine that uses encryption to ensure privacy.
