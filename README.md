...
- [CloudBank](https://github.com/omgbbqhaxx/cloudbankproject) First ever POWWT (Proof of work with time) consensus algorihm crypto curreny with python without fee all miners share constant reward between them.
